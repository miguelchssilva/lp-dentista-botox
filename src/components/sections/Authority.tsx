...
export function Authority() {
  return (
    <MotionSection id="sobre" className="bg-porcelain py-20 sm:py-28 lg:py-32">
      <div className="mx-auto grid max-w-7xl gap-14 px-5 sm:px-6 lg:grid-cols-[0.95fr_1.05fr] lg:items-center lg:px-8">
        <div className="relative">
          ...
          <div className="absolute bottom-7 right-7 rounded-[20px] bg-champagne px-7 py-6 text-center text-white shadow-[0_24px_60px_rgba(14,37,43,0.18)]">
            <p className="font-display text-4xl leading-none">CRO</p>
        ...
        <div className="lg:pl-4">
          ...
          <h2 className="mt-5 font-display text-5xl leading-[1.02] text-ink sm:text-6xl lg:text-[4.7rem]">
            Dr. João Henrique Nagildo
          </h2>
          <p className="mt-4 text-sm font-bold uppercase tracking-[0.18em] text-ink/44">
            {site.cro}
          </p>
          <p className="mt-8 max-w-2xl font-display text-3xl italic leading-[1.35] text-ink/78">
            "Minha missão é elevar a autoestima com resultados que valorizam a
            essência, sem exageros ou transformações artificiais."
          </p>
          <p className="mt-7 max-w-2xl text-[17px] leading-9 text-ink/62">
